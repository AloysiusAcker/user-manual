...
export const NotionIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg className={className} viewBox="0 0 42 42" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M24.83 3.95H38.05V38.04H24.83V3.95Z" fill="currentColor"></path>
    <path d="M3.95 3.95H17.17V24.83H3.95V3.95Z" fill="currentColor"></path>
    <path d="M3.95 24.83H17.17V38.05H3.95V24.83Z" fill="currentColor"></path>
  </svg>
);
...
export const TeamspaceIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
export const GeneratedIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg className={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
